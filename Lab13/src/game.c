...
void FillArray(int n, struct Game games[n]){
    char names[N][30] = {"Doom", "Portal", "Terraria", "Minecraft", "Among Us", 
                         "Limbo", "Hades", "Braid", "Fez", "Inside"};
    char genres[N][30] = {"Shooter", "Puzzle", "Sandbox", "Sandbox", "Social", 
                          "Platformer", "Roguelike", "Puzzle", "Platformer", "Adventure"};
